			...
			try
			{
				...
				else if(initialize == 1) // Initialization, connect to respective IPs and ports **********************************************
				{
					if(serverID == 1)
					{
						...
						serverIP = InetAddress.getByName("141.117.232.41"); // IP Address of serverID == 1
						waitForPrevServer();
						initialize = 0;
					...
					else if(serverID == 2)
					{
						...
						serverIP = InetAddress.getByName("141.117.232.42"); // IP Address of serverID == 2
						initialize = 0;
						forP2PClient = new DatagramSocket(40231);
					}
					else if(serverID == 3)
					{
						waitForPrevServer();
						...
						serverIP = InetAddress.getByName("141.117.232.43"); // IP Address of serverID == 3
						initialize = 0;
						forP2PClient = new DatagramSocket(40231);
					}
					else if(serverID == 4)
					{
						...
						serverIP = InetAddress.getByName("141.117.232.44"); // IP Address of serverID == 4
						initialize = 0;
						forP2PClient = new DatagramSocket(40231);
					}
				}
