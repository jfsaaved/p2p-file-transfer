...
public class P2PClient {
	...
	public static void main(String [] args) throws IOException
	{
		...
		InetAddress IPAddress = InetAddress.getByName("141.117.232.41"); // Change this to IP Address of serverID == 1
			...
			else if (sentence.equals("3"))
			{
				...
				else
				{
					...
					// Send FTP request and receive the new TCP
					 ...
					 Socket clientSocket = new Socket(InetAddress.getByName(message),40232);
					 System.out.println("Sent");
